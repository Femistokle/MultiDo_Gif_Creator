                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card mb-4 mb-xl-0">
                            <div class="card-header border-0  pb-0">
                                <div>
                                    <h4 class="text-black fs-20">{{$room->number}}</h4>
                                ...
                                <div class="dropdown custom-dropdown mb-0">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item"
                                           href="{{route('admin.rooms.edit', $room->id)}}">Изменить</a>
                                        <a class="dropdown-item text-danger"
                                           href="{{route('admin.rooms.delete', $room->id)}}">Удалить</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body ">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        ...
                                        <span class="mb-0">#{{$room->id}}</span>
                                    </li>
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        <strong class="mr-2">Кол-во уроков</strong>
                                        <span class="mb-0">{{$room->lessons()->count()}}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <table id="example2" class="display">
                                                ...
                                                @foreach($room->lessons as $lesson)
                                                    <tr>
                                                        <td>{{$lesson->id}}</td>
                                                        <td>
                                                            <a class="text-primary" href="{{route('admin.courses.course',$lesson->id)}}">{{$lesson->course->name}}</a>
                                                        </td>
                                                        <td><a class="text-primary" href="{{route('admin.groups.group',$lesson->course->group_id)}}">{{$lesson->course->group->name}}</a></td>
                                                        <td>{{$lesson->course->group->students()->count()}}</td>
