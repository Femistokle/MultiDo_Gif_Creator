<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li class="@if(request()->is('admin/departments*')) mm-active @endif">
                <a class="ai-icon" href="{{route('admin.departments.all')}}">
                    <i class="fa fa-book-open"></i>
                    <span class="nav-text">Кафедры</span>
                </a>
            </li>
            <li class="@if(request()->is('admin/rooms*')) mm-active @endif">
                <a class="ai-icon" href="{{route('admin.rooms.all')}}">
                    <i class="fa fa-location-arrow" ></i>
                    <span class="nav-text">Кабинеты</span>
                </a>
            </li>
            <li class="@if(request()->is('admin/teachers*')) mm-active @endif">
                <a class="ai-icon" href="{{route('admin.teachers.all')}}">
                    <i class="fa fa-user-tie" ></i>
                    <span class="nav-text">Преподаватели</span>
                </a>
            </li>
            <li class="@if(request()->is('admin/groups*')) mm-active @endif">
                <a class="ai-icon" href="{{route('admin.groups.all')}}">
                    <i class="fa fa-users" ></i>
                    <span class="nav-text">Группы</span>
                </a>
            </li>
            <li class="@if(request()->is('admin/students*')) mm-active @endif">
                <a class="ai-icon" href="{{route('admin.students.all')}}">
                    <i class="fa fa-graduation-cap"></i>
                    <span class="nav-text">Студенты</span>
                </a>
            </li>
            <li class="@if(request()->is('admin/courses*') || request()->is('admin/lessons*')) mm-active @endif">
                <a class="ai-icon" href="{{route('admin.courses.all')}}">
...
{{--                    <li><a href="{{route('admin.lessons.all')}}">Список уроков</a></li>--}}
{{--                    <li><a href="{{route('admin.lessons.new')}}">Добавить урок</a></li>--}}
{{--                </ul>--}}
{{--            </li>--}}
