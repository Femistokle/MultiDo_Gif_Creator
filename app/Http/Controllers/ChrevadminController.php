...
class ChrevadminController extends Controller
{
    ...
    public function dashboard_1()
    {
        ...
        return view('layout.schedule', compact('page_title', 'page_description','action','logo','logoText'));
    }
    ...
    public function my_wallet()
    {
        ...
        return view('dashboard.my_wallet', compact('page_title', 'page_description','action','logo','logoText'));
    }
    ...
    public function portfolio()
    {
        ...
        return view('dashboard.portfolio', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // Transactions
